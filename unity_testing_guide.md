...
### Test A — Day 1 (Normal):
4. Pergi ke planet (trigger exploration).
5. Perhatikan kecepatan drain O2 di HUD.
6. Di Console, perhatikan drain per frame.
...
10. Pergi ke planet lagi — O2 harus drain **25% lebih cepat**.
...
### Langkah:
1. Tekan **Play**.
2. Pergi ke planet (trigger exploration).
