...
namespace AstroPioneer.Core
{
    ...
    public static class SaveSystem
    {
        ...
        /// Atomic Snapshot: Data is copied on the Main Thread to isolated buffers 
        /// before being offloaded to a background thread for disk I/O.
        /// </summary>
        public static void SaveChunkBinary(Chunk chunk, int worldSeed)
        {
            ...
            // 1. Atomic Snapshot (Main Thread - Very Fast)
            // We copy to fresh arrays to ensure gameplay mutations don't corrupt the save data.
            ...
            // Clone ComplexStates (Cloned to prevent main-thread modification mid-save)
            ...
            // 2. Offload I/O to Background Thread
            Task.Run(() =>
            {
                try
                {
...
namespace AstroPioneer.Machines
{
    ...
    public class ProcessingStation : MonoBehaviour, IPowerConsumer
    {
        ...
        private void PerformCatchUp(float elapsedSeconds)
        {
            ...
            float totalProgressTime = (processProgress * craftTime) + elapsedSeconds;
            
            if (totalProgressTime >= craftTime)
            {
                CompleteCurrentRecipe();
            }
            else
            {
                processProgress = totalProgressTime / craftTime;
            }
